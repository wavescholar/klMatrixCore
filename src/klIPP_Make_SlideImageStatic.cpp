...
//This is a placeholder for klIPP_Make_SlideImage_MacroThumb_9_0.  It simply rotates the greyscale WSI from the Hamamatsu.
extern "C" bool klIPP_Make_SlideImage_WSIRotate_9_0(const char* macro,const char* thumbnail,const char* ofile)
{
	...
	{
		throw "Bad input file for thumbnail image in klIPP_Make_SlideImage_MacroThumb_9_0(char* macro, char* thumb,char* ofile)";
	}
	...
	{
		throw "Bad imput file for label image in klIPP_Make_SlideImage_MacroThumb_9_0(char* macro, char* thumb,char* ofile)";

	}	
	if(macrobands!=thumbbands)
	{
		throw "Bad imput file for image in klIPP_Make_SlideImage_MacroThumb_9_0(char* macro, char* thumb,char* ofile)";
	}
...
//For images comming off the Hamamatsu, this is the case.  We choose not to use the marco as provided since it is a BW image.
extern "C" bool klIPP_Make_SlideImage_MacroThumb_9_0(const char* macro,const char* thumbnail,const char* ofile)
{
	unsigned int thumbwidth=0;
	unsigned int thumbheight=0;
	unsigned int thumbbands=0;
...
extern "C" bool klIPP_Make_SlideImage_Macro_9_0(const char* thumbnail,const char* label,const char* ofile)
{
...
//This is called when (isMacro && isLabel).  This should be the default case when ingesting images directly off the scanner.
...
extern "C" bool klIPP_Make_SlideImage_9_0(const char* thumbnail,const  char* label,const char* ofile)
{
...
//This method is unfinished and not used in the FW release.
 extern "C" bool klIPP_Make_SlideImage_LT_9_0(const char* thumbnail,const char* label,const char* ofile)
{
...
//Partial Implementation
 extern "C" double klIPP_Calculate_ROI_To_Tissue_Ratio(const char* WSI)
{
