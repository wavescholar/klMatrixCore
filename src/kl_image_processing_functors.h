...
public:
	...
	void operator()(void)
	{
		...
		if(src->numBands() !=1 && src->numBands()!=3)
			throw ": klFilterFunctor : band number of bands, onle one and three band images supported at this time.";
...
public:
	...
	void operator()(void){
		...
		if(src->numBands() !=1 && src->numBands()!=3)
			throw ": klErodeFunctor : band number of bands, onle one and three band images supported at this time.";
...
public:
	...
	void operator()(void){
		...
		if(src->numBands() !=1 && src->numBands()!=3)
			throw "klDilateFunctor : band number of bands, onle one and three band images supported at this time.";
...
public:
	...
	klRasterBufferPointer operator()(void)
	{
		...
		if(m_src->numBands() !=1 && m_src->numBands()!=3)
			throw ": klResizeFunctor : band number of bands, onle one and three band images supported at this time.";
...
public:
	...
	klRasterBufferPointer operator()(void)
	{
		...
		if(m_src->numBands() !=1 && m_src->numBands()!=3)
			throw ": klRotateFunctor : band number of bands, onle one and three band images supported at this time.";
...
public:
	...
	void operator()(void)
	{
		if(src->numBands() !=3 && dst->numBands()!=1)
			throw "klColorToGrayFunctor : band number of bands, onle one and three band images supported at this time.";
