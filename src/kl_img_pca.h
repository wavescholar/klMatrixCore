...
class klApplyStainSpaceBasis{
public:
	klApplyStainSpaceBasis(klRasterBufferPointer lsrc)
		: src(lsrc)
	{
...
class klStainPurity{
public:
	klStainPurity(klRasterBufferPointer lsrc )
		: src(lsrc)
	{
	...
	klRasterBufferPointer operator()(void)
	{
		...
		if(inbands!=3)
			throw "klStainPurity input bands must be 3";
